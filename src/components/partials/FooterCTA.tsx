const FooterCTA = () => {
  return (
    <div className='container flex flex-col items-center px-4 py-12 mx-auto text-center border-2 border-primary-400 dark:border-primary-300 rounded-sm bg-white dark:bg-gray-800'>
      <h2 className='text-3xl font-bold tracking-tight text-gray-600 dark:text-white'>
        Try something really different right now.
      </h2>
      <p className='block max-w-2xl mt-6 text-lg text-gray-500 dark:text-gray-300'>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iusto recusandae tenetur iste quaerat
