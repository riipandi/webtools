...
const Header = ({ ...props }) => {
  ...
  return (
    <header className='bg-white shadow dark:bg-gray-900 absolute top-0 w-full'>
      <nav className='justify-between max-w-5xl mx-auto p-6'>
        <div className='container flex items-center justify-center text-gray-600 capitalize dark:text-gray-300'>
          <Link href='/'>
            <a className='text-gray-800 transition-colors duration-200 transform dark:text-gray-200 border-b-2 border-blue-500 mx-1.5 sm:mx-6'>
              home
            </a>
          </Link>
          <a
      ...
      <div className='hidden absolute z-30 top-0 lg:flex items-center justify-center w-full py-4 mx-auto lg:justify-end lg:py-6 lg:px-10'>
